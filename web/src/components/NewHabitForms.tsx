  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        ...
        className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900"
        autoFocus
        value={title}
